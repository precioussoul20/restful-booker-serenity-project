...
public class BookingCRUDTestWithSteps extends TestBase {
    ...
    static String firstName = TestUtils.getRandomValue() + "Madhuri";
    static String lastname = TestUtils.getRandomValue() + "Dixit";
    static int totalprice = 500;
    static boolean depositpaid = true;
    static String additionalneed = "Lunch";
